...
The crate carries 24 tests: 15 common workflow tests and 9 tagma-sec-specific property tests. The README usage example is additionally compiled as a doctest.
