...
| Java 21 | `sw/java` | tagma-core, base11172, tagma-geo, tagma-sec, tagma-map, bench | 342 JUnit tests, `sw/java/run.sh` |
...
```sh
sw/cpp/run.sh              # C++: configure, build, ctest (14 suites)
